...
/* Glowing top border on sidebar */
[data-testid="stSidebar"] > div:first-child {
  border-top: 2px solid var(--cyan) !important;
  box-shadow: 0 2px 20px rgba(0,212,255,.2) !important;
}
...
/* Sidebar collapse button — styled */
[data-testid="collapsedControl"] {
  background: var(--card2) !important;
  border: 1px solid var(--b2) !important;
  border-radius: 0 10px 10px 0 !important;
  color: var(--cyan) !important;
  box-shadow: 2px 0 16px rgba(0,212,255,.15) !important;
  transition: all .2s !important;
}
[data-testid="collapsedControl"]:hover {
  background: rgba(0,212,255,.15) !important;
  box-shadow: 2px 0 24px rgba(0,212,255,.3) !important;
}
...
@media (max-width: 768px) {
  ...
  /* Breathing room for main content */
  ...
  .mega-banner .sub { font-size: .65rem !important; }

  /* KPI cards */
  .kpi { padding: 12px 8px !important; }
  .kpi-val  { font-size: 1.8rem !important; }
  .kpi-lbl  { font-size: .6rem !important; }
  .kpi-icon { font-size: 1.3rem !important; }
  ...
  /* Badges */
  .b { font-size: .58rem !important; padding: 2px 5px !important; }

  /* Alerts */
  .al { font-size: .78rem !important; padding: 10px 11px !important; }
  ...
  /* Mini stat boxes */
  .mm { padding: 9px 10px !important; }
  .mm-val { font-size: 1.1rem !important; }

  /* Sidebar wider on mobile for easier tapping */
  [data-testid="stSidebar"] {
...
@media (min-width: 769px) and (max-width: 1024px) {
  ...
  .mega-banner h1 { font-size: 1.2rem !important; }
}
</style>
