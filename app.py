...
# 2. הזרקת עיצוב CSS - החזרת המראה היוקרתי והכהה
st.markdown("""
    <style>
    ...
    .fc { max-height: 650px !important; background: white !important; padding: 10px !important; border-radius: 15px !important; }
    </style>
...
if st.session_state.user_role is None:
    ...
    st.markdown("<p style='text-align: center; font-size: 1.5rem; color: #64748b; margin-bottom: 50px;'>ניהול לוגיסטי חכם | בחר תפקיד לכניסה</p>", unsafe_allow_html=True)
